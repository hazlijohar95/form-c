...
function ensureSprite() {
  ...
  if (first) document.body.insertBefore(svg, first);
...
export function Icon(props: IconProps) {
  const { name, size, ["aria-hidden"]: ariaHidden, ...rest } = props;
  const known = Object.prototype.hasOwnProperty.call(icons, name);
  const resolved = known ? (name as keyof typeof icons) : "plus";
